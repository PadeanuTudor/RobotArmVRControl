...
- Open issues and PRs at the repository. Keep changes focused and include brief rationale and testing steps.
...
- Repository: https://github.com/PadeanuTudor/ProjectComp

---

If you want, I can also generate a `CONTRIBUTING.md` and a minimal `.editorconfig` consistent with the project's coding style.
